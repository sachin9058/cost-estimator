        ...
        <main className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-100 py-20 px-6">
            <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-10 border border-orange-200">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-10">
                    ...
                    <div>
                        <label className="block mb-1 font-medium">Labour Hours</label>
                        <input
                            type="number"
                            name="laborHours"
                    ...
                    <div className="mt-8 bg-white rounded-xl border border-orange-200 p-6 shadow">
                        ...
                        <ul className="space-y-4 max-h-96 overflow-y-auto">
                            {savedEstimations.map((estimation, index) => (
                                <li key={index} className="border border-orange-100 rounded-lg p-4 bg-orange-50 hover:bg-orange-100 transition-all">
                                    <Link href={`/estimation/${estimation._id}`}>
                                        <div className="cursor-pointer">
                                            ...
                                            <p className="text-orange-600 text-sm mt-1 underline">View Full Report →</p>
                                        </div>
                                    </Link>
                                </li>
                            ))}
